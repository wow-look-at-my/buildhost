...
require (
	...
	github.com/wow-look-at-my/bin-file-fmt/go v0.0.0 // go-toolchain:auto-branch
	...
	github.com/wow-look-at-my/router v0.0.0 // go-toolchain:auto-branch
...
require github.com/wow-look-at-my/go-regex-compiler v0.0.0 // go-toolchain:auto-branch
...
replace (
	...
	modernc.org/ccgo/v4 v4.34.2 => gitlab.com/cznic/ccgo/v4 v4.34.2
)
...
replace (
	...
	modernc.org/gc/v3 v3.1.3 => gitlab.com/cznic/gc/v3 v3.1.3
)
