...
`internal/api/project_name.go` is generated by [go-regex-compiler](https://github.com/wow-look-at-my/go-regex-compiler). To regenerate:

```bash
GOPROXY=direct go run github.com/wow-look-at-my/go-regex-compiler/cmd/regex-gen@master \
  -regex '^[a-z0-9][a-z0-9._-]{0,127}$' \
  -func validProjectName -package api \
  -output internal/api/project_name.go -match full
```
