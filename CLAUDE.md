...
- `internal/db/` - SQLite database layer (modernc.org/sqlite, no CGo), OIDC policy storage, data types. Types generated by sqlc; methods, constants, and validation in `types.go`
