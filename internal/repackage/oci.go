...
// apeImageLauncher is the shebang every entrypoint spelling reaches: the kernel
// cannot exec an APE. Unpacking needs a writable, non-noexec dir, and /tmp gets
// a noexec tmpfs. Depth: docs/deploy-and-updates.md.
